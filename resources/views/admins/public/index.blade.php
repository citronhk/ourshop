			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="glyphicon glyphicon-th-list"></i> <span>分类管理</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="/admin/cates" class="">分类列表</a></li>
									<li><a href="/admin/cates/create
										" class="">分类添加</a></li>
