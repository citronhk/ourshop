...
@section('main')
  ...
  <script type="text/javascript" src="/registers/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
    <div style="margin-top: 30px;">
      <form name="demo" action="/home/addr/{{ $addr->id }}" method="post">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
          @if (count($errors) > 0)
     ...
     <table border="0" class="add_tab" style="width:930px; height: 300px;text-align:center;"  cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="font-family:'宋体';"><input type="text" name="addr_name" value="{{ $addr->addr_name }}" class="add_ipt" /></td>
              </tr>
              <tr>
                <td align="right">收货人姓名</td>
                <td style="font-family:'宋体';"><input type="text" name="order_name" value="{{ $addr->order_name}}" class="add_ipt" />（必填）</td>
                <td align="right">电子邮箱</td>
                <td style="font-family:'宋体';"><input type="text" name="email" value="{{ $addr->email }}" class="add_ipt"/></td>
              </tr>
              <tr>
                <td align="right">详细地址</td>
                <td style="font-family:'宋体';"><input type="text" name="order_addr" value="{{ $addr->order_addr }}" class="add_ipt" />（必填）</td>
                <td align="right">邮政编码</td>
                <td style="font-family:'宋体';"><input type="text" name="postal" value="{{ $addr->postal }}" class="add_ipt" /></td>
              </tr>
              <tr>
                <td align="right">手机</td>
                <td style="font-family:'宋体';"><input type="text" name="phone" value="{{ $addr->phone }}" class="add_ipt" />（必填）</td>
                <td align="right">电话</td>
                <td style="font-family:'宋体';"><input type="text" name="telephone" value="{{ $addr->telephone }}" class="add_ipt" /></td>
              </tr>
             <tr>
                ...
                <td colspan="3" style="font-family:'宋体';">
                    ...
                    <p style="color: red;float: right; font-size: 18px">（★★请务必重新选择★★）</p>
                </td>
              </tr>
            ...
            <p align="right">
              &nbsp; &nbsp; <a onclick="demo.submit()" class="add_b" style="margin:20px 30px auto auto">确认修改</a>
            </p> 
    </div>
