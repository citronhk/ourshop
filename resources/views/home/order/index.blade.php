      ...
      <div class="two_bg">
          <div class="two_t">
            ...
            <table border="0" class="car_tab" style="width:830px; margin-left:50px ;margin-bottom:50px;" cellspacing="0" cellpadding="0">
              ...
              @endforeach
            <!-- <form name="demo2" action="home/order/result" method="post">
              {{ csrf_field() }} -->
            </table>
            ...
            <table border="0" class="peo_tab" style="width:830px; margin-left:50px ;margin-bottom:50px;" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="395"><input type="text" name="order_name" style="width:100%; height:100%"></td>
                <td class="p_td" width="160">手机</td>
                <td width="395"><input type="text" name="phone" style="width:100%; height:100%"></td>
              </tr>
              <tr>
                <td class="p_td">详细地址</td>
                <td width="395"><input type="text" name="order_addr" style="width:100%; height:100%"></td>
                <td class="p_td">邮政编码</td>
                <td width="395"><input type="text" name="postal" style="width:100%; height:100%"></td>
              </tr>
            </table>
